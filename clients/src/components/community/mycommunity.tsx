...
export default function MyCommunity({handleSelectedCommunity,community}:{handleSelectedCommunity:(v:string)=>void, community:(v:string|null)=>void}){

      const {userId} = useUser();
    
     const {data,isLoading,isError} = useQuery({
        queryKey:["myCommunity",userId],
